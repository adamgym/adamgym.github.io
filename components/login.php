  ...
  <div class="container">
    <form class="form-container-login" action="login.php" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan E-mail" name="email" Required>
      </div>
      <div class="mb-3">
      ...
      <p><i style="color: red;"><?= $login_message ?></i></p>
